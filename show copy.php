public function getShowerHTML() {
		...
		<style>
			...
			.myDiv {
				...
				background: #000000;
				/* color: white; */
				color: <?php echo get_option('td_myDiv'); ?>;
				padding-top: 6px;
				padding-bottom: 6px;
				font-family: 'Kanit', sans-serif;
			}
			...
			.md-text{
				...
				height: 6px;
				/* color: blue; */
				color: <?php echo get_option('md_text'); ?>;
			...
			td.myDiv:not(:hover) {
				...
				color: <?php echo get_option('td_myDiv'); ?>!important; /* หรือสีอื่น ๆ ที่คุณต้องการให้เหมือนตัวอย่าง */
			}
		...
		<?php
		$html_content = ob_get_clean(); // ดึงเนื้อหาที่บันทึกไว้
		return $html_content;
	}